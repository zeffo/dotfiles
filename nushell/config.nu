...
$env.PROMPT_COMMAND = {
  [
    ...
    ($env.USER)
    (ansi {fg: $theme.pink bg: $theme.rosewater})
    (char -u e0bc)
    (ansi {fg: $theme.rosewater bg: $theme.flamingo})
    (char -u e0bc)
    (ansi {fg: $theme.flamingo bg: $theme.maroon})
    (char -u e0bc)
    (ansi {fg: $theme.maroon bg: $theme.red})
    (char -u e0bc)
    (ansi reset)
    (ansi {fg: $theme.base bg: $theme.red})
    (pwd | str replace $env.HOME '~')
    (ansi {fg: $theme.red bg: $theme.base})
    (char -u e0b4)
    (ansi {fg: $theme.pink})
    (char newline)
    ($"(char -u f4c8) ")
