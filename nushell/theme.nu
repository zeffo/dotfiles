...
let scheme = {
  recognized_command: { fg: $theme.pink attr: b }
...
$env.config.explore = {
    status_bar_background: { fg: $theme.base, bg: $theme.mauve  },
    status_bar_text: {fg: $theme.base, bg: $theme.mauve},
